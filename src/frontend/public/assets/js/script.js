...
var HTMLquestions = [
  ...
  {
    /*5*/ question: 'How can you make a bulleted list with numbers? ',
...
var PYquestions = [
  ...
  {
    question:
      'What is the output of the following program : (tricky ques.)  print (0.1 + 0.2 == 0.3) ',
...
document.querySelector('.view-results').addEventListener('click', function () {
  ...
  if (correct / (countQues + 1) > 0.8) {
    ...
    document.querySelector('.remark').innerHTML =
      'Remark: Satisfactory, Learn More.';
  } else {
    document.querySelector('.remark').innerHTML =
      'Remark: Unsatisfactory, Try Again.';
  }
